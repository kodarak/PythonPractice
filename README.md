...
```
**генератор списку з умовою, що додає елемент з string до списку, який не є числом, та приєднує кожен символ без пробілу за допомогою join**
### 4
```python
...
```
**генератор списку з додаванням цілих чисел до nums з nums**
### 6
```python
print("\nРядок без чисел:", letters)
```
**виведення рядка без чисел**
### 7
```python
...
```
**виведення зміненого рядка, який містить слова, що починаються й закінчуються великою літерою**
### 10
```python
print("Максимальний елемент масиву:", max(nums))
```
**знаходить і виводить максимальне значення в масиві чисел**
### 11
```python
nums.remove(max(nums))
```
**просто видаляє максимальне значення в масиві чисел, щоб воно не заважало іншим числам, які будуть підноситися до степеню по їх індексу**
### 12
```python
...
```
**виводить масив чисел, які піднесені до степеню по їх індексу**
