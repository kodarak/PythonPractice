...
**Просто запускаємо код у редакторі коду (Visual Studio Code і т.д.) та бачимо, що програма успішно запустилася. Як результат побачимо віконну програму, в якій реалізовані основні функції калькулятора: додавання, віднімання, множення, ділення; додаткові функції: знаходження значень синуса, косинуса, тангенса, котангенса, логарифма, натурального логарифма, ділення за модулем;**<br>
